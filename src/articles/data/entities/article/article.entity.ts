...
import { ArticleVoteEntity } from '../article-vote/article-vote.entity';
...
export class ArticleEntity {
   ...
   */
  @Field(() => [ArticleVoteEntity], { nullable: 'itemsAndList' })
  @OneToMany(() => ArticleVoteEntity, (vote) => vote.article)
  votes?: ArticleVoteEntity[];
